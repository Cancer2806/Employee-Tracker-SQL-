...
const { viewAllEmployees, addEmployee, updateRole, viewDeptEmployees, deleteEmployee, deptBudget, updateManager, viewEmployeesMgr } = require('./src/employees');
    ...
    .then((actions) => {
      ...
      switch (chosenAction) {
        ...
        case 'View Employees by Manager':
          // Call function to read employee records for a specified department and then display with console.table
          return selectEmployee("Which manager's employees would you like to see:")
            .then((response) => {
              const { employee } = response;
              viewEmployeesMgr(employee)
                .then((result) => {
                  console.clear();
                  console.log(`Press up/down arrow to continue \n \n`);
                  console.table(result);
        ...
        case `Update an Employee's Manager`:
          // prompt for employee name and employee's new manager
          return selectEmployee("Which employee do you want to change")
            .then((response) => {
              const { employee, manager } = response;
        ...
        case 'Delete an Employee':
          ...
          return selectEmployee("Which employee do you want to delete")
            .then((response) => {
              const { employee } = response;
